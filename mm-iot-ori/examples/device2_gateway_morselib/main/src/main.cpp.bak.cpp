...
static uint8_t improv_adv_data[] = {
    ...
    0x03, 0x02, 0x00, 0xFF, // Complete list of 16-bit service UUIDs (0xFF00 for Improv)
    0x0F, 0x09, 'I', 'm', 'p', 'r', 'o', 'v', ' ', 'G', 'a', 't', 'e', 'w', 'a', 'y' // Complete Local Name
};
...
extern "C" void app_main(void) {
    ...
    if (err != ESP_OK) {
        LOG_ERROR("Failed to initialize BLE Improv!");
    }
